...
export default class CompanySelect extends Component {
  ...
  render() {   
    ...
    return (
      <select className="form-control rounded-0" id={this.props.id} required={this.props.required} disabled={readonly} onChange={(e)=> this.handleChange(e)} value={this.props.setValue}>
